...
The test suite uses a synthetic xlsx (`tests/test_attendees.xlsx`) generated by `tests/generate_test_xlsx.py` and covers both MDB and Lenex paths, Masters routing, and error handling. See `tests/test_integration.py` for the full manual SPLASH workflow documented as comments.
