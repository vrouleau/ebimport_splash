#!/usr/bin/env python3
"""Core logic for ebimport_splash: read xlsx, validate, route age groups."""
...
# --------------------------------------------------------------------------- #
MEET_NATION = "CAN"
# Age reference date for Masters bracket routing.  Set by load_to_lenex.py.
...
# Each xlsx ticket label maps to a catalog UNIQUEID and a flag saying whether
# it's an individual or relay entry.  UIDs below match the Championnats
# canadiens 2026 meet template:
#
...
# --------------------------------------------------------------------------- #
# Template dataclasses (shared between MeetLxfTemplate and callers)
# --------------------------------------------------------------------------- #
@dataclass
class TemplateStyle:
    swim_style_id: int
