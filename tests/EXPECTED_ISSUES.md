...
===== Summary of changes =====
  ...
  +1     new SWIMSESSION
  +5     new clubs
  +106   new athletes               # 100 base + 6 injected defect athletes
  +51    new events                  # 42 ind + 9 relay
  +51    new age-group rows
  +360   new individual entries
  +18    new relay squads
...
expect `361 individual entries` and `69 relay member entries` because
...
| WARNING | `missing_name` | 1 | row 433 (no first name) |
